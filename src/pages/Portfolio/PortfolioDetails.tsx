...
//   return (
//     <div className="flex flex-col bg-[#E8ECEE] w-full h-[70%] relative overflow-hidden">
...
//       <div className="hidden md:flex flex-col items-center justify-center   relative z-20 pb-[3.25rem]">
...
//       {/* App Image Section */}
//       <div className="relative mt-6 md:mt-18 pb-0">
//         <div className="relative w-full h-[50vh] md:h-[70vh]  overflow-hidden  ">
//           <div className="absolute top-[14rem] left-1/2 transform -translate-x-1/2 -translate-y-1/4 md:-translate-y-1/3 w-full max-w-7xl z-30">
//             <img
