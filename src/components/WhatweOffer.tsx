...
function WhatweOffer() {
  ...
  return (
    <div className="flex justify-center bg-[#FFFFFF66] pt-48 font-hedvig-serif gap-20">
      <div className="flex flex-col justify-between font-visby">
        <div className="bg-white rotate-[5deg] rounded-2xl shadow-md px-4 py-2 inline-block hover:shadow-lg transition-all duration-300">
          Design systems
        </div>
      ...
      <div className="flex justify-center items-center flex-col">
        ...
        <h1 className="flex text-center text-[56px] leading-[73px] font-normal">
      ...
      <div className="flex flex-col justify-between font-visby">
        ...
        <div className="bg-white rounded-2xl shadow-md px-4 py-2 inline-block hover:shadow-lg transition-all duration-300 ml-6">
          Prototyping
        </div>
