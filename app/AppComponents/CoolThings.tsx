...
function CoolThings() {
  ...
  return (
    <div className="w-full">
      <div className={`flex flex-col pb-28 pt-12 ${isMobile ? "px-4" : ""}`}>
        <div className="flex justify-center items-center flex-col font-hedvig-serif">
          <div className="flex items-center pb-4 text-[#A7ACC1] gap-4 text-2xl font-normal decoration-neutral-400">
            ...
            <h1 className={`font-light ${isMobile ? "text-sm" : ""}`}>
              Cool Things
            </h1>
          ...
          <div className="flex flex-col w-2/3 justify-center gap-4 pt-6 font-visby font-normal w-full max-w-2xl">
            <p className="text-center text-[#323442] text-lg font-light leading-7 gap-3 flex flex-col ">
              At Exthgen, we prioritize your work-life balance with flexible
              hours and remote work options. Our commitment to professional
              development ensures you grow alongside our innovative projects.
            </p>
          </div>
      ...
      <div className="w-screen">
        <Image src="/coolthings.png" alt="" width={0} height={0} className="w-full" />
      </div>

      <div className={`flex justify-center items-center flex-col font-hedvig-serif mb-12 pt-12 ${isMobile ? "px-4" : ""}`}>
